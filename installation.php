...
if ($_SERVER['REQUEST_METHOD'] ==='POST') {
    ...
    try {
        ...
        $pdo -> exec ("CREATE TABLE IF NOT EXISTS orders (
            ...
            order_status ENUM('PENDING', 'DELIVERED', 'DECLINED') NOT NULL,
            FOREIGN KEY (cust_id) REFERENCES reg_customers(cust_id) ON DELETE SET NULL
        )");
        ...
        $pdo -> exec("CREATE TABLE IF NOT EXISTS menu_titles (
            ...
            menu_title VARCHAR(255) NOT NULL UNIQUE ,
        ...
        // setting currency
        // $formattedAmount = number_format($amount, 0, '.', ',') . ' TZS';
        // const formattedAmount = amount.toLocaleString('sw-TZ', { style: 'currency', currency: 'TZS' });
                ...
                <form action="./installation.php" method="post" onsubmit="return validate()">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="input" name="db_host" id="db_host" required>
                        </div>
                        <div class="form-group">
                            <label for="db_user">Username:</label>
                            <input type="text" class="input" name="db_user"  id="db_user">
                        </div>
                        <div class="form-group">
                            <label for="db_pass">Password:</label>
                            <input type="password" class="input" name="db_pass" id="db_pass">
                        </div>
                        <div class="form-group">
                            <label for="db_name">Database Name:</label>
                            <input type="text" class="input" name="db_name" id="db_name" required>
                    </fieldset>
                    <fieldset>
